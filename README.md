...
- **Inverter Interfaces:** Fronius GEN24 (with automatic firmware detection), legacy fallback, generic Home Assistant inverter control (e.g., Marstek, Sungrow, Goodwe), and more or via mqtt contols/ web api controls/ evcc external interver control.
